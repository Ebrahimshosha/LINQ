...
namespace Session_1
{
    class SortingDesc : IComparer<int>
    {
        public int Compare(int x, int y)
        {
            return y.CompareTo(x); // or ↓
            //return y - x;
        }
    }
    class Unitstockcomparer : IComparer<Product>
    {
    ...
    class Product : IComparable<Product>
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return this.ProductID.Equals(product.ProductID) && this.ProductName.Equals(product.ProductName)
                && this.Category.Equals(product.Category) && this.UnitPrice.Equals(product.UnitPrice)
        ...
        public override int GetHashCode()
        {
            return this.ProductID.GetHashCode() ^ this.ProductName.GetHashCode() ^
                   this.Category.GetHashCode() ^ this.UnitPrice.GetHashCode() ^ this.UnitsInStock.GetHashCode();
        }
